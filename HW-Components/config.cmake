...
option(use_hwcomponents_algorithms_serial_rod "Use algorithms serial_rod" ON)
option(use_prebuilt_hwcomponents_algorithms_serial_rod "Use prebuilt algorithms serial_rod" ON)

option(use_hwcomponents_algorithms_power_limiter "Use algorithms power_limiter" ON)
option(use_prebuilt_hwcomponents_algorithms_power_limiter "Use prebuilt algorithms power_limiter" ON)
# devices

option(use_hwcomponents_devices_cap "Use cap device" ON)
option(use_prebuilt_hwcomponents_devices_cap "Use prebuilt cap" ON)
...
option(use_hwcomponents_devices_vision "Use vision device" ON)
option(use_prebuilt_hwcomponents_devices_vision "Use prebuilt vision" ON)
...
option(use_hwcomponents_bsp_comm "Use bsp comm" ON)
option(use_prebuilt_hwcomponents_bsp_comm "Use prebuilt comm" ON)

option(use_hwcomponents_bsp_software_i2c "Use bsp software I2C" ON)
option(use_prebuilt_hwcomponents_bsp_comm "Use prebuilt software I2C" ON)
